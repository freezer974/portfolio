...
<<<<<<< HEAD:resources/views/accueil.blade.php
                    <div class="col-lg-4 col-sm-6 cat{{ $image->category_id }} grid-item p-1">
=======
                    <div class="col-lg-3 col-md-4 col-sm-6 cat{{ $image->category_id }} grid-item p-1">
>>>>>>> ce58649bab3f0debf218ce1dd119272559d67cf4:resources/views/accueil.blade.php
